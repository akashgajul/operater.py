...
class Application:
    def __init__(self, master):
        ...
        self.heading = Label(self.left, text = "HOSPITAL APPOINTMENTS", font = ('arial 40 bold'), fg ='blue', bg = 'lightgreen')
        self.heading.place(x=0, y=0)


        self.name = Label(self.left, text = "Patient's Name", font =('arial 10 bold'), fg = 'black', bg = 'lightgreen')
        self.name.place(x =0, y = 100)

        self.age =Label(self.left, text = "Age", font =('arial 10 bold'), fg = 'black', bg = 'lightgreen')
        self.age.place(x = 0, y =140)


        self.gender = Label(self.left, text="Gender", font=('arial 10 bold'), fg='black', bg='lightgreen')
        self.gender.place(x=0, y=180)

        self.location = Label(self.left, text="Location", font=('arial 10 bold'), fg='black', bg='lightgreen')
        self.location.place(x=0, y=220)

        self.time = Label(self.left, text="Appointment time", font=('arial 10 bold'), fg='black', bg='lightgreen')
        self.time.place(x=0, y=260)

        self.phone =Label(self.left, text ="Phone", font =('arial 10 bold'), fg ='black', bg ='lightgreen')
